...
import { FileText, Code, Palette, Megaphone, Search, Clock, CheckCircle, AlertCircle, ChevronRight, Zap, Star, ArrowLeft } from 'lucide-react';
      ...
      <nav className="border-b border-green-900 bg-black/50 backdrop-blur sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            <Link to="/" className="flex items-center gap-2 text-green-400/60 hover:text-green-400 transition-colors">
          ...
          <div className="bg-black border-2 border-green-500 rounded-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            <div className="p-8">
              <div className="flex justify-between items-start mb-6">
                ...
                <button onClick={() => setSelectedBounty(null)} className="text-green-400 hover:text-green-300 text-2xl">
                  ✕
                </button>
              </div>
